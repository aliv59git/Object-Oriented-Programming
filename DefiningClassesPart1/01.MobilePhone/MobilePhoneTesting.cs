...
namespace MobilePhone
{
    ...
    class MobilePhoneTesting
    {
        static void Main(string[] args)
        {
            ...
            Battery bat = new Battery("Polymer", 520, 38);
            ...
            Console.WriteLine("My Mobile Phone is: {0} from {1}. \nIt costed {2} leva, \nhas batery (Model: {3}, HoursIddle: {4} hours and HoursTalk: {5} hours), \ndisplay (NumberOfColcors: {6} and Size: {7} cm (5.1\")) \nand his owner instanly is {8}",
                myPhone.Model, myPhone.Manifacturer, myPhone.Price, phoneBattery.Model, phoneBattery.HoursIddle, phoneBattery.HoursTalk, mobileDisplay.NumberOfColors, mobileDisplay.Size, myPhone.Owner);
            Console.WriteLine();
            Console.WriteLine("My Phone has {0} batteri with HoursIddle {1} and HoursTalk {2}.", bat.Model, bat.HoursIddle, bat.HoursTalk);
            Console.WriteLine("My Phone has Capacitive TouchScreen display with {0} NumberOfColors and {1} cm diagonal.", mobileDisplay.NumberOfColors, mobileDisplay.Size);
            Console.WriteLine(bat.Model);
            Console.WriteLine(bat.HoursIddle);
